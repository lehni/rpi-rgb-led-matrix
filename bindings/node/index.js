...
class RGBLedMatrix {
  constructor(options = {}) {
    ...
    // The process needs to run as root also for better PWM handling, see
    // https://github.com/hzeller/rpi-rgb-led-matrix#running-as-root
    this.interface = spawn('sudo', ['./rgb-led-interface', ...args], {
      cwd: __dirname,
